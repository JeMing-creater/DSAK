...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks,in_channels=3, num_classes=10, normalize_coefs=None, normalize=False):
...
def ResNet34(in_channels=3,num_classes=10, normalize_coefs=None, normalize=False):
    return ResNet(BasicBlock, [3, 4, 6, 3],in_channels, num_classes, normalize_coefs=normalize_coefs, normalize=normalize)
